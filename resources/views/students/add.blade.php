            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-person-lines-fill"></i> Añadir Nuevo Estudiante
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Añadir Nuevo Estudiante</li>
                        </ol>
                    </nav>
                    ...
                    <p class="text-primary">
                        <small><i class="bi bi-exclamation-diamond-fill me-2"></i> Recuerda crear un "Curso" y "Sección" antes de crear un nuevo estudiante</small>
                    </p>
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.student.create')}}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control" id="inputBirthday" name="birthday" placeholder="Fecha de nacimiento" required value="{{old('birthday')}}">
                                </div>
                                <div class="col-3-md">
                                    <label for="inputAddress" class="form-label">Direccion principal<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="city" placeholder="Talca" required value="{{old('city')}}">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <label for="inputNationality" class="form-label">Pais de origen<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="inputReligion" class="form-select" name="religion" required>
                                        ...
                                        <option {{old('religion') == 'Buddhism' ? 'selected' : ''}}>Budhismo</option>
                                        <option {{old('religion') == 'Judaism' ? 'selected' : ''}}>Judaismo</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputPhone" name="phone" placeholder="+569 xxxx xxxx " required value="{{old('phone')}}">
                                </div>
                                <div class="col-5-md">
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputFatherName" name="father_name" placeholder="Nombre" required value="{{old('father_name')}}">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputFatherPhone" class="form-label">Telefono del Padre<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                    <input type="text" class="form-control" id="inputFatherPhone" name="father_phone" placeholder="+569 xxxx xxxx " required value="{{old('father_phone')}}">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputMotherName" class="form-label">Nombre de la Madre<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                    <input type="text" class="form-control" id="inputMotherName" name="mother_name" placeholder="Nombre" required value="{{old('mother_name')}}">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputMotherPhone" class="form-label">Telefono de la madre<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                    <input type="text" class="form-control" id="inputMotherPhone" name="mother_phone" placeholder="+569 xxxx xxxx " required value="{{old('mother_name')}}">
                                </div>
                                <div class="col-4-md">
                                    <label for="inputParentAddress" class="form-label">Direccion<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                    <input type="text" class="form-control" id="inputParentAddress" name="parent_address" placeholder="Av. argentina 1420" required value="{{old('parent_address')}}">
                                </div>
                            </div>
                            <div class="row mt-4 g-3">
                                <h6>Informacion Académica</h6>
                                <div class="col-md-6">
                                    <label for="inputAssignToClass" class="form-label">Asignar a la clase:<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
