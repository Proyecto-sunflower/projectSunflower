                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="btn-group" role="group">
                                                @can('edit users')
                                                    <a href="{{route('manage.manage-student-grades', ['id' => $student->student->id])}}" role="button" class="btn btn-sm btn-outline-secondary" style="color: black;"><i class="bi bi-pen"></i> Agregar o editar notas</a>
                                                @endcan
