                ...
                <div class="row pt-2">
                    <div class="col ps-4">
                        ...
                        <div class="col-md-6" style="margin: 40px;">
                            <label for="selectCourse" class="form-label">Nombre del alumno: {{ $student->first_name }}
                                {{ $student->last_name }}</label><br>
                            @if ($current_semester)
                                <label for="selectCourse" class="form-label">Semestre:
                                    {{ $current_semester->semester_name }}</label><br>
                            @else
                            ...
                            <form action="{{ route('grades.update') }}" method="POST">
                                ...
                                <div style="display: flex; justify-content: center;">
                                    <button type="submit" class="mt-3 btn btn-sm btn-outline-primary"
                                        style="align-self: center; color: black; border-color: black;"><i
