    ...
    <div class="d-flex flex-column align-items-center align-items-sm-start ">
                <ul class="nav flex-column pt-2 w-100">
                    ...
                    <li class="nav-item">
                        ...
                        @endphp
                        <a class="nav-link d-flex {{ request()->is('classes')? 'active' : '' }}" href="{{url('classes')}}"><i class="bi bi-diagram-3"></i> <span class="ms-2 d-inline d-sm-none d-md-none d-xl-inline">Asignaturas</span> <span class="ms-auto d-inline d-sm-none d-md-none d-xl-inline">{{ $classCount }}</span></a>
                    </li>
                    @endcan
                    ...
                    @if(Auth::user()->role != "student")
                    <li class="nav-item border-bottom">
                        <a class="nav-link {{ request()->is('manageGrades')? 'active' : '' }}" href="{{url('manageGrades')}}"><i class="ms-auto bi bi-grid"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Administrar notas</span></a>
                    </li>
                    <li class="nav-item border-bottom">
                    ...
                    @if (Auth::user()->role == "admin")
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('academics*')? 'active' : '' }}" href="{{url('academics/settings')}}"><i class="bi bi-tools"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Año academico</span></a>
                    </li>
                    @endif
                    <!-- @if (!session()->has('browse_session_id') && Auth::user()->role == "admin")
                    <li class="nav-item">
