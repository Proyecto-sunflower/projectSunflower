...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-file-plus"></i> Agregar regla de calificación<!--Add Grading Rule--></h1>
                        ...
                        <div class="col-5 mb-4">
                            <div class="p-3 border bg-light">
                                <form action="{{route('exam.grade.system.rule.store')}}" method="POST">
                                    ...
                                    <div class="mt-2">
                                        <label for="inputGrade" class="form-label">Nota<!--Grade--><sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                        <input type="text" name="grade" class="form-control" id="inputGrade" placeholder="A+, A-, ...">
                                    </div>
                                    <div class="mt-2">
                                        <label for="inputStarts" class="form-label">Comienzo<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
